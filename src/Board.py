...
from MoveValidator import VerticalMoveValidator, HorizontalMoveValidator, DiagonalMoveValidator
...
class Board:
    ...
    def is_king_exposed(self, color):
        ...
        for validator in [VerticalMoveValidator(), HorizontalMoveValidator(), DiagonalMoveValidator()]:
    ...
    def find_king(self, color):
        # Iterate through the tiles to find the position of the king
        for position, piece in self.tiles.items():
            if isinstance(piece, King) and piece.color == color:
                #print("King position: " + str(position))
                return position
